#!/bin/bash
#SBATCH --job-name=32interp_train-4    # nom du job
...
#SBATCH --output=32interp_train4_%j.out  # nom du fichier de sortie
#SBATCH --error=32interp_train4_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --chkp_save_path /gpfswork/rech/ynx/uds36vp/repos/wf-SEDs/interp_SED_model/wf-outputs-4/chkp/32_bins/ \
