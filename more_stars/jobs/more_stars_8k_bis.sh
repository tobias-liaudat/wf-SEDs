#!/bin/bash
#SBATCH --job-name=more_stars_8k_bis_    # nom du job
...
#SBATCH --output=more_stars_8k_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=more_stars_8k_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _more_stars_8k_bis_1"
opt[1]="--id_name _more_stars_8k_bis_2"
opt[2]="--id_name _more_stars_8k_bis_3"
opt[3]="--id_name _more_stars_8k_bis_4"
opt[4]="--id_name _more_stars_8k_bis_5"
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _more_stars_8k_bis_ \
