#!/bin/bash
#SBATCH --job-name=more_stars_1k_bis_    # nom du job
...
#SBATCH --output=more_stars_1k_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=more_stars_1k_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _more_stars_1k_bis_ \
