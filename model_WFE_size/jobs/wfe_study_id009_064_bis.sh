#!/bin/bash
#SBATCH --job-name=wfe_study_id009_064_bis_    # nom du job
...
#SBATCH --output=wfe_study_id009_064_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=wfe_study_id009_064_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _wfe_study_id009_064_bis_ \
