#!/bin/bash
#SBATCH --job-name=wfe_study_resx3_064_bis_    # nom du job
...
#SBATCH --output=wfe_study_resx3_064_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=wfe_study_resx3_064_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _wfe_study_resx3_064_bis_6"
opt[1]="--id_name _wfe_study_resx3_064_bis_7"
opt[2]="--id_name _wfe_study_resx3_064_bis_8"
opt[3]="--id_name _wfe_study_resx3_064_bis_9"
opt[4]="--id_name _wfe_study_resx3_064_bis_10"
opt[5]="--id_name _wfe_study_resx3_064_bis_11"
opt[6]="--id_name _wfe_study_resx3_064_bis_12"
opt[7]="--id_name _wfe_study_resx3_064_bis_13"
opt[8]="--id_name _wfe_study_resx3_064_bis_14"
opt[9]="--id_name _wfe_study_resx3_064_bis_15"
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _wfe_study_resx3_064_bis_ \
