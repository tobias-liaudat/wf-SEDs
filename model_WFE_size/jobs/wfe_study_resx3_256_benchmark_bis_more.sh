#!/bin/bash
#SBATCH --job-name=wfe_study_resx3_256_benchmark_bis_    # nom du job
...
#SBATCH --output=wfe_study_resx3_256_benchmark_bis_%j.out  # nom du fichier de sortie
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _wfe_study_resx3_256_benchmark_bis_ \
