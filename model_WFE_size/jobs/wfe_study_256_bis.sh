#!/bin/bash
#SBATCH --job-name=wfe_study_256_bis_    # nom du job
...
#SBATCH --output=wfe_study_256_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=wfe_study_256_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _wfe_study_256_bis_1"
opt[1]="--id_name _wfe_study_256_bis_2"
opt[2]="--id_name _wfe_study_256_bis_3"
opt[3]="--id_name _wfe_study_256_bis_4"
opt[4]="--id_name _wfe_study_256_bis_5"
...
srun python -u ./train_eval_plot_script_click.py \
    ...
    --base_id_name _wfe_study_256_bis_ \
