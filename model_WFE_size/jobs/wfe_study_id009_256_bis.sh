#!/bin/bash
#SBATCH --job-name=wfe_study_id009_256_bis_    # nom du job
...
#SBATCH --output=wfe_study_id009_256_bis_%j.out  # nom du fichier de sortie
#SBATCH --error=wfe_study_id009_256_bis_%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _wfe_study_id009_256_bis_1"
opt[1]="--id_name _wfe_study_id009_256_bis_2"
opt[2]="--id_name _wfe_study_id009_256_bis_3"
opt[3]="--id_name _wfe_study_id009_256_bis_4"
opt[4]="--id_name _wfe_study_id009_256_bis_5"
opt[5]="--id_name _wfe_study_id009_256_bis_6"
opt[6]="--id_name _wfe_study_id009_256_bis_7"
opt[7]="--id_name _wfe_study_id009_256_bis_8"
opt[8]="--id_name _wfe_study_id009_256_bis_9"
