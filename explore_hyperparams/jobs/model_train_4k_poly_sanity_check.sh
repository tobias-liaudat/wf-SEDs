#!/bin/bash
#SBATCH --job-name=sanity_check    # nom du job
...
#SBATCH --output=sanity_check %j.out  # nom du fichier de sortie
#SBATCH --error=sanity_check %j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name model_poly_d_max_5 --d_max_nonparam 5"
