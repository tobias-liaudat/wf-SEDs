#!/bin/bash
#SBATCH --job-name=2_cycles_256_batch   # nom du job
...
#SBATCH --output=2_cycles_256_batch%j.out  # nom du fichier de sortie
#SBATCH --error=2_cycles_256_batch%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _2_cycles_256_no_proj_d2_45z_0 --n_zernikes 45 "
opt[1]="--id_name _2_cycles_256_no_proj_d2_45z_1 --n_zernikes 45 "
opt[2]="--id_name _2_cycles_256_no_proj_d2_45z_2 --n_zernikes 45 "
opt[3]="--id_name _2_cycles_256_no_proj_d2_45z_3 --n_zernikes 45 "
opt[4]="--id_name _2_cycles_256_no_proj_d2_45z_4 --n_zernikes 45 "
opt[5]="--id_name _2_cycles_256_no_proj_d2_60z_0 --n_zernikes 60 "
opt[6]="--id_name _2_cycles_256_no_proj_d2_60z_1 --n_zernikes 60 "
opt[7]="--id_name _2_cycles_256_no_proj_d2_60z_2 --n_zernikes 60 "
opt[8]="--id_name _2_cycles_256_no_proj_d2_60z_3 --n_zernikes 60 "
opt[9]="--id_name _2_cycles_256_no_proj_d2_60z_4 --n_zernikes 60 "
