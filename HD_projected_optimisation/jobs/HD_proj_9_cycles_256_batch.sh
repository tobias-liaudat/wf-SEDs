#!/bin/bash
#SBATCH --job-name=9_cycles_256_batch   # nom du job
...
#SBATCH --output=9_cycles_256_batch%j.out  # nom du fichier de sortie
#SBATCH --error=9_cycles_256_batch%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _9_cycles_256_proj_d2_45z_0 --project_dd_features True"
opt[1]="--id_name _9_cycles_256_proj_d2_45z_1 --project_dd_features True"
opt[2]="--id_name _9_cycles_256_proj_d2_45z_2 --project_dd_features True"
opt[3]="--id_name _9_cycles_256_proj_d2_45z_3 --project_dd_features True"
opt[4]="--id_name _9_cycles_256_proj_d2_45z_4 --project_dd_features True"
opt[5]="--id_name _9_cycles_256_no_proj_d2_45z_0 --project_dd_features False"
opt[6]="--id_name _9_cycles_256_no_proj_d2_45z_1 --project_dd_features False"
opt[7]="--id_name _9_cycles_256_no_proj_d2_45z_2 --project_dd_features False"
opt[8]="--id_name _9_cycles_256_no_proj_d2_45z_3 --project_dd_features False"
opt[9]="--id_name _9_cycles_256_no_proj_d2_45z_4 --project_dd_features False"
