...
opt[0]="--id_name _9_cycles_256_hd_proj_reset_eval_param_0 --eval_only_param True --total_cycles 9 --saved_cycle cycle9"
opt[1]="--id_name _9_cycles_256_hd_proj_reset_eval_param_1 --eval_only_param True --total_cycles 9 --saved_cycle cycle9"
opt[2]="--id_name _9_cycles_256_hd_proj_reset_eval_param_2 --eval_only_param True --total_cycles 9 --saved_cycle cycle9"
opt[3]="--id_name _9_cycles_256_hd_proj_reset_eval_param_3 --eval_only_param True --total_cycles 9 --saved_cycle cycle9"
opt[4]="--id_name _9_cycles_256_hd_proj_reset_eval_param_4 --eval_only_param True --total_cycles 9 --saved_cycle cycle9"

opt[5]="--id_name _9_cycles_256_hd_proj_reset_eval_full_0 --eval_only_param False --total_cycles 9 --saved_cycle cycle9"
opt[6]="--id_name _9_cycles_256_hd_proj_reset_eval_full_1 --eval_only_param False --total_cycles 9 --saved_cycle cycle9"
opt[7]="--id_name _9_cycles_256_hd_proj_reset_eval_full_2 --eval_only_param False --total_cycles 9 --saved_cycle cycle9"
opt[8]="--id_name _9_cycles_256_hd_proj_reset_eval_full_3 --eval_only_param False --total_cycles 9 --saved_cycle cycle9"
opt[9]="--id_name _9_cycles_256_hd_proj_reset_eval_full_4 --eval_only_param False --total_cycles 9 --saved_cycle cycle9"
