...
opt[0]="--id_name _2_cycles_pretrained_train_param_0"
opt[0]="--id_name _2_cycles_pretrained_train_param_1"
opt[0]="--id_name _2_cycles_pretrained_train_param_2"
opt[0]="--id_name _2_cycles_pretrained_train_param_3"
opt[0]="--id_name _2_cycles_pretrained_train_param_4"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --base_id_name _2_cycles_pretrained_train_param_ \
