...
opt[0]="--id_name _2_cycles_256_no_proj_d2_45z --n_zernikes 45 "
opt[1]="--id_name _2_cycles_256_no_proj_d2_60z --n_zernikes 60 "
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --suffix_id_name 45z --suffix_id_name 60z  \
    --star_numbers 45 --star_numbers 60 \
