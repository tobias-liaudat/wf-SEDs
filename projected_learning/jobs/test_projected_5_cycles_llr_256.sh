#!/bin/bash
#SBATCH --job-name=5_cycles_llr_256   # nom du job
...
#SBATCH --output=5_cycles_llr_256%j.out  # nom du fichier de sortie
#SBATCH --error=5_cycles_llr_256%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _5_cycles_llr_256_no_proj_d2 --project_dd_features False --d_max 2"
opt[1]="--id_name _5_cycles_llr_256_proj_d2 --project_dd_features True --d_max 2"
opt[2]="--id_name _5_cycles_llr_256_proj_d5 --project_dd_features True --d_max 5"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --base_id_name _5_cycles_llr_256_ \
