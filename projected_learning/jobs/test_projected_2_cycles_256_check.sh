#!/bin/bash
#SBATCH --job-name=2_cycles_256_check   # nom du job
...
#SBATCH --output=2_cycles_256_check%j.out  # nom du fichier de sortie
#SBATCH --error=2_cycles_256_check%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _2_cycles_256_check_no_proj_d2 --project_dd_features False --d_max 2"
opt[1]="--id_name _2_cycles_256_check_proj_d2 --project_dd_features True --d_max 2"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --base_id_name _2_cycles_256_check_ \
    --suffix_id_name no_proj_d2 --suffix_id_name proj_d2  \
