#!/bin/bash
#SBATCH --job-name=9_cycles_llr_256   # nom du job
...
#SBATCH --output=9_cycles_llr_256%j.out  # nom du fichier de sortie
#SBATCH --error=9_cycles_llr_256%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _9_cycles_llr_256_no_proj_d2 --project_dd_features False --d_max 2"
opt[1]="--id_name _9_cycles_llr_256_proj_d2 --project_dd_features True --d_max 2"
opt[2]="--id_name _9_cycles_llr_256_proj_d5 --project_dd_features True --d_max 5"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --l_rate_non_param_multi_cycle "0.1 0.95 0.9 0.85 0.8 0.75 0.7 0.65 0.06" \
    ...
    --base_id_name _9_cycles_llr_256_ \
