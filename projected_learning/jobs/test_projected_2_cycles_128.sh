#!/bin/bash
#SBATCH --job-name=2_cycles_128   # nom du job
...
#SBATCH --output=2_cycles_128%j.out  # nom du fichier de sortie
#SBATCH --error=2_cycles_128%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _2_cycles_128_no_proj_d2 --project_dd_features False --d_max 2"
opt[1]="--id_name _2_cycles_128_proj_d2 --project_dd_features True --d_max 2"
opt[2]="--id_name _2_cycles_128_no_proj_d5 --project_dd_features False --d_max 5"
opt[3]="--id_name _2_cycles_128_proj_d5 --project_dd_features True --d_max 5"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --base_id_name _2_cycles_128_ \
    --suffix_id_name no_proj_d2 --suffix_id_name proj_d2 --suffix_id_name no_proj_d5 --suffix_id_name proj_d5 \
    --star_numbers 2 --star_numbers 3 --star_numbers 4 --star_numbers 5\
