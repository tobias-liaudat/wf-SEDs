#!/bin/bash
#SBATCH --job-name=5_cycles_256_no_proj   # nom du job
...
#SBATCH --output=5_cycles_256_no_proj%j.out  # nom du fichier de sortie
#SBATCH --error=5_cycles_256_no_proj%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _5_cycles_256_no_proj_d2_0"
opt[1]="--id_name _5_cycles_256_no_proj_d2_1"
opt[2]="--id_name _5_cycles_256_no_proj_d2_2"
opt[3]="--id_name _5_cycles_256_no_proj_d2_3"
opt[4]="--id_name _5_cycles_256_no_proj_d2_4"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --base_id_name _5_cycles_256_no_proj_d2_ \
