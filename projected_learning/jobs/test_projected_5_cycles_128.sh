#!/bin/bash
#SBATCH --job-name=5_cycles_128   # nom du job
...
#SBATCH --output=5_cycles_128%j.out  # nom du fichier de sortie
#SBATCH --error=5_cycles_128%j.err   # nom du fichier d'erreur (ici commun avec la sortie)
...
opt[0]="--id_name _5_cycles_128_no_proj_d2 --project_dd_features False --d_max 2"
opt[1]="--id_name _5_cycles_128_proj_d2 --project_dd_features True --d_max 2"
opt[2]="--id_name _5_cycles_128_proj_d5 --project_dd_features True --d_max 5"
...
srun python -u ./train_project_click_multi_cycle.py \
    ...
    --l_rate_non_param_multi_cycle "0.1 0.1 0.1 0.1 0.06" \
    --l_rate_param_multi_cycle "0.01 0.008 0.008 0.004 0.004" \
    --total_cycles 5 \
    --saved_cycle cycle5 \
    --model poly \
    --model_eval poly \
